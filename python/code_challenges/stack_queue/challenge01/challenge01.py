...
class Stack:
    ...
    def pop(self):
        '''removes the node from the top of the stack, and returns the nodes value'''
        if self.top:
            temp = self.top
...
class myQueue:
    ...
    def pop(self):
        '''removes the node from the first position of the queue, and returns the nodes value'''
